...
public class PanelQuanLyMonAn extends javax.swing.JPanel implements MouseListener {
    ...
    private void initComponents() {
        ...
        lblMaMon.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lblMaMon.setText("Mã món:");
        txtMaMon.setEditable(false);
        txtMaMon.setFont(new java.awt.Font("Segoe UI", 0, 14));
        txtMaMon.setFocusable(false);
        ...
        lblTenMon.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lblTenMon.setText("Tên món:");
        txtTenMon.setFont(new java.awt.Font("Segoe UI", 0, 14));
        ...
        lblLoaiMon.setFont(new java.awt.Font("Segoe UI", 0, 14));
        ...
        lblHinhAnh.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lblHinhAnh.setText("Hình ảnh:");
        lblDonViTinh.setFont(new java.awt.Font("Segoe UI", 0, 14));
                ...
                pnlThongTinKhuyenMaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pnlThongTinKhuyenMaiLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlThongTinKhuyenMaiLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(pnlThongTinKhuyenMaiLayout.createSequentialGroup()
                                                .addComponent(txtTimKiem, javax.swing.GroupLayout.DEFAULT_SIZE, 291,
                                                        Short.MAX_VALUE)
                                                .addGap(24, 24, 24)
                                        ...
                                        .addGroup(pnlThongTinKhuyenMaiLayout.createSequentialGroup()
                                                ...
                                                .addGap(4, 4, 4)
                                                .addComponent(lblIconMonAn, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
