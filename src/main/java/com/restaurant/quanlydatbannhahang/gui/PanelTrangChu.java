...
public class PanelTrangChu extends javax.swing.JPanel {
    ...
    private void loadDataToCard() {
        try {
            ...
            lblSumDoanhThu.setText(CurrencyUtility.formatVND(doanhThuHomNay));
        } catch (Exception e) {
            e.printStackTrace();
            ...
            DefaultTableCellRenderer currencyRenderer = new DefaultTableCellRenderer() {
                ...
                protected void setValue(Object value) {
                    if (value instanceof Double) {
                        setText(CurrencyUtility.formatVND((Double) value));
                    } else {
    ...
    private void initComponents() {
        ...
        lblCountBanSuDung.setFont(new java.awt.Font("Segoe UI", 1, 28));
        ...
        lblCountBanDatTruoc.setFont(new java.awt.Font("Segoe UI", 1, 28));
        ...
        lblSumDoanhThu.setFont(new java.awt.Font("Segoe UI", 1, 28));
