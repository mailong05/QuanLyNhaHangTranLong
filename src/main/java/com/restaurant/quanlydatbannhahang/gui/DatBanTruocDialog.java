...
public class DatBanTruocDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 480, 280));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatBanTruocDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
